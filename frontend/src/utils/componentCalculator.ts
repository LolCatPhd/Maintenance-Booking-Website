...
import { PLACEHOLDER_ICON, componentImages } from '../data/componentImages';

/**
 * Get component image URL, fallback to placeholder if not found
 */
function getComponentImage(partNumber: string): string {
  return componentImages[partNumber] || PLACEHOLDER_ICON;
}
...
const COMPONENT_INFO: Record<string, { name: string; unit: string; image: string }> = {
  'KDS-MC35-40P': { name: 'Mid Clamps', unit: 'pieces', image: getComponentImage('KDS-MC35-40P') },
  'KDS-END CLAMP-P': { name: 'End Clamps (Portrait)', unit: 'pieces', image: getComponentImage('KDS-END CLAMP-P') },
  'KDS-END CLAMP-A': { name: 'End Clamps (Angle)', unit: 'pieces', image: getComponentImage('KDS-END CLAMP-A') },
  'KDS-EARTH-BAR-MP': { name: 'Earth Bar (Module)', unit: 'pieces', image: getComponentImage('KDS-EARTH-BAR-MP') },
  'CLASS3-STITCH-14X22': { name: 'Self-Tapping Screws', unit: 'pieces', image: getComponentImage('CLASS3-STITCH-14X22') },
  'KDS-IBR78-PCSLOT': { name: 'IBR Roof Brackets', unit: 'pieces', image: getComponentImage('KDS-IBR78-PCSLOT') },
  'KDS-IBR250-ADJ2F-PCSLOT': { name: 'IBR Adjustable Brackets', unit: 'pieces', image: getComponentImage('KDS-IBR250-ADJ2F-PCSLOT') },
  'KDS-RAIL-LT': { name: 'KDS Rails (Light)', unit: 'pieces', image: getComponentImage('KDS-RAIL-LT') },
  'KDS-RAIL-LT-4400mm': { name: 'KDS Rails (Light) 4400mm', unit: 'pieces', image: getComponentImage('KDS-RAIL-LT-4400mm') },
  'KDS-RAIL-LT-4720mm': { name: 'KDS Rails (Light) 4720mm', unit: 'pieces', image: getComponentImage('KDS-RAIL-LT-4720mm') },
  'KDS-RAIL-LT-6600mm': { name: 'KDS Rails (Light) 6600mm', unit: 'pieces', image: getComponentImage('KDS-RAIL-LT-6600mm') },
  'KDS-U-JOIN': { name: 'Rail Joiners (U-Joint)', unit: 'pieces', image: getComponentImage('KDS-U-JOIN') },
  'KDS-PC30': { name: 'Shared Rails (PC30)', unit: 'pieces', image: getComponentImage('KDS-PC30') },
  'KDS-COR78-PCSLOT': { name: 'Corrugated Roof Brackets', unit: 'pieces', image: getComponentImage('KDS-COR78-PCSLOT') },
  'KDS-COR200-PCSLOT': { name: 'Corrugated Portrait Brackets', unit: 'pieces', image: getComponentImage('KDS-COR200-PCSLOT') },
  'KDS-CL78-PCSLOT': { name: 'Cliplock Brackets', unit: 'pieces', image: getComponentImage('KDS-CL78-PCSLOT') },
  'KDS-CL78-PCSLOT-500NRP': { name: 'Cliplock Portrait Brackets', unit: 'pieces', image: getComponentImage('KDS-CL78-PCSLOT-500NRP') },
  'KDS-DD120-PCSLOT': { name: 'Diamond Deck Brackets', unit: 'pieces', image: getComponentImage('KDS-DD120-PCSLOT') },
  'KDS-NOVOT78-PCSLOT': { name: 'Novotexi Brackets (Non-penetrating)', unit: 'pieces', image: getComponentImage('KDS-NOVOT78-PCSLOT') },
  'KDS-NOVOT78-PCSLOT-PEN': { name: 'Novotexi Brackets (Penetrating)', unit: 'pieces', image: getComponentImage('KDS-NOVOT78-PCSLOT-PEN') },
  'KDS-HANG-BOLT-BRACKET-P': { name: 'Hang Bolt Brackets', unit: 'pieces', image: getComponentImage('KDS-HANG-BOLT-BRACKET-P') },
  'KDS-HANG-BOLT-M10X200W': { name: 'Hang Bolts M10x200', unit: 'pieces', image: getComponentImage('KDS-HANG-BOLT-M10X200W') },
  'KDS-DS700-78-PCSLOT': { name: 'DS700 Brackets', unit: 'pieces', image: getComponentImage('KDS-DS700-78-PCSLOT') },
  'KDS-SLATE/HARVEY-1-KIT': { name: 'Slate/Harvey Kit', unit: 'kits', image: getComponentImage('KDS-SLATE/HARVEY-1-KIT') },
  'KDS-SS120-4.52H-PCSLOT': { name: 'Standing Seam Brackets', unit: 'pieces', image: getComponentImage('KDS-SS120-4.52H-PCSLOT') },
  'KDS-IBR120-15TILT-LS-F-AC': { name: 'Tilt-up Front Brackets (AC)', unit: 'pieces', image: getComponentImage('KDS-IBR120-15TILT-LS-F-AC') },
  'KDS-IBR120-15TILT-LS-R-AC': { name: 'Tilt-up Rear Brackets (AC)', unit: 'pieces', image: getComponentImage('KDS-IBR120-15TILT-LS-R-AC') },
  'KDS-BALLAST-HOLD': { name: 'Ballast Holders', unit: 'pieces', image: getComponentImage('KDS-BALLAST-HOLD') },
  'KDS-BALLAST-12': { name: 'Ballast Blocks', unit: 'pieces', image: getComponentImage('KDS-BALLAST-12') },
  'KDS-RWD-BH-LS': { name: 'A-Frame Rear Brackets', unit: 'pieces', image: getComponentImage('KDS-RWD-BH-LS') },
  'EPDM1.5-PSA-1190X50': { name: 'EPDM Protection Mat', unit: 'meters', image: getComponentImage('EPDM1.5-PSA-1190X50') },
  'CLASS3-TEK-SCREW-No.12x25mm-NS': { name: 'Tek Screws for Metal Roof', unit: 'pieces', image: getComponentImage('CLASS3-TEK-SCREW-No.12x25mm-NS') },
  'KDS-AF13-25ADJ-LS-2PP-1135': { name: 'A-Frame Front Brackets (15° Adjustable)', unit: 'pieces', image: getComponentImage('KDS-AF13-25ADJ-LS-2PP-1135') },
  'KDS-GUSSET-P-F-BH': { name: 'A-Frame Gussets', unit: 'pieces', image: getComponentImage('KDS-GUSSET-P-F-BH') },
  'KDS-AF15FX-GUSS-LS-BNW': { name: 'A-Frame Gussets (Fixed)', unit: 'pieces', image: getComponentImage('KDS-AF15FX-GUSS-LS-BNW') },
  'SS304-WASHER-FLAT-M12': { name: 'M12 Flat Washers (Stainless)', unit: 'pieces', image: getComponentImage('SS304-WASHER-FLAT-M12') },
  'SS304-NUT-M12': { name: 'M12 Nuts (Stainless)', unit: 'pieces', image: getComponentImage('SS304-NUT-M12') },
  'SS304-THREAD-M12': { name: 'M12 Threaded Rods (Stainless)', unit: 'pieces', image: getComponentImage('SS304-THREAD-M12') },
  'KDS-SAFE-FIX300': { name: 'Ground Mounting Posts', unit: 'pieces', image: getComponentImage('KDS-SAFE-FIX300') },
  'KDS-AF15FX-HW-PORT-BNW': { name: 'A-Frame Hardware (Portrait)', unit: 'sets', image: getComponentImage('KDS-AF15FX-HW-PORT-BNW') },
  'KDS-AF15FX-HW-LS-BNW': { name: 'A-Frame Hardware (Landscape)', unit: 'sets', image: getComponentImage('KDS-AF15FX-HW-LS-BNW') },
  'KDS-TILE-P': { name: 'Tile Roof Brackets', unit: 'pieces', image: getComponentImage('KDS-TILE-P') },
  'ZP-SCREW-TPS-6.35X60': { name: 'Tile Fixing Screws 6.35x60', unit: 'pieces', image: getComponentImage('ZP-SCREW-TPS-6.35X60') },
  'KDS-BNWT-DBL': { name: 'Double Ballast Nuts/Washers', unit: 'pieces', image: getComponentImage('KDS-BNWT-DBL') },
  'KDS-IBR120-PCSLOT': { name: 'IBR 120mm Brackets', unit: 'pieces', image: getComponentImage('KDS-IBR120-PCSLOT') },
  'KDS-IBR250-2F-15TILT-LS-R-AL': { name: 'IBR Tilt-up Rear Brackets (Landscape AL)', unit: 'pieces', image: getComponentImage('KDS-IBR250-2F-15TILT-LS-R-AL') },
  'KDS-IBR250-2F-15TILT-LS-F-AL': { name: 'IBR Tilt-up Front Brackets (Landscape AL)', unit: 'pieces', image: getComponentImage('KDS-IBR250-2F-15TILT-LS-F-AL') },
  'KDS-IBR120-15TILT-P-R-AC': { name: 'IBR Tilt-up Rear Brackets (Portrait AC)', unit: 'pieces', image: getComponentImage('KDS-IBR120-15TILT-P-R-AC') },
  'KDS-IBR120-15TILT-P-F-AC': { name: 'IBR Tilt-up Front Brackets (Portrait AC)', unit: 'pieces', image: getComponentImage('KDS-IBR120-15TILT-P-F-AC') },
  'KDS-IBR250-2F-15TILT-P-R-AL': { name: 'IBR Tilt-up Rear Brackets (Portrait AL)', unit: 'pieces', image: getComponentImage('KDS-IBR250-2F-15TILT-P-R-AL') },
  'KDS-IBR250-2F-15TILT-P-F-AL': { name: 'IBR Tilt-up Front Brackets (Portrait AL)', unit: 'pieces', image: getComponentImage('KDS-IBR250-2F-15TILT-P-F-AL') },
  'KDS-COR200-15TILT-P-R-AL': { name: 'Corrugated Tilt-up Rear Brackets (Portrait AL)', unit: 'pieces', image: getComponentImage('KDS-COR200-15TILT-P-R-AL') },
  'KDS-COR200-15TILT-P-F-AL': { name: 'Corrugated Tilt-up Front Brackets (Portrait AL)', unit: 'pieces', image: getComponentImage('KDS-COR200-15TILT-P-F-AL') },
  'KDS-NOVOT120-PCSLOT': { name: 'Novotexi 120mm Brackets', unit: 'pieces', image: getComponentImage('KDS-NOVOT120-PCSLOT') },
  'KDS-DS700-120-PCSLOT': { name: 'DS700 120mm Brackets', unit: 'pieces', image: getComponentImage('KDS-DS700-120-PCSLOT') },
  'EPDM1.5-PSA-1730x50': { name: 'EPDM Protection Mat (1730mm)', unit: 'meters', image: getComponentImage('EPDM1.5-PSA-1730x50') },
  'KDS-RWD-BH-PORT': { name: 'A-Frame Rear Brackets (Portrait)', unit: 'pieces', image: getComponentImage('KDS-RWD-BH-PORT') },
  'KDS-AF13-25ADJ-PORT-BNW': { name: 'A-Frame Front Brackets (Portrait Adjustable)', unit: 'pieces', image: getComponentImage('KDS-AF13-25ADJ-PORT-BNW') },
  'KDS-AF15FX-GUSS-PORT-BNW': { name: 'A-Frame Gussets (Portrait)', unit: 'pieces', image: getComponentImage('KDS-AF15FX-GUSS-PORT-BNW') },
  'KDS-COR120-15TILT-LS-R-AC': { name: 'Corrugated Tilt-up Rear Brackets (Landscape AC)', unit: 'pieces', image: getComponentImage('KDS-COR120-15TILT-LS-R-AC') },
  'KDS-COR120-15TILT-LS-F-AC': { name: 'Corrugated Tilt-up Front Brackets (Landscape AC)', unit: 'pieces', image: getComponentImage('KDS-COR120-15TILT-LS-F-AC') },
  'KDS-COR200-15TILT-LS-R-AL': { name: 'Corrugated Tilt-up Rear Brackets (Landscape AL)', unit: 'pieces', image: getComponentImage('KDS-COR200-15TILT-LS-R-AL') },
  'KDS-COR200-15TILT-LS-F-AL': { name: 'Corrugated Tilt-up Front Brackets (Landscape AL)', unit: 'pieces', image: getComponentImage('KDS-COR200-15TILT-LS-F-AL') },
  'KDS-COR120-15TILT-P-R-AC': { name: 'Corrugated Tilt-up Rear Brackets (Portrait AC)', unit: 'pieces', image: getComponentImage('KDS-COR120-15TILT-P-R-AC') },
  'KDS-COR120-15TILT-P-F-AC': { name: 'Corrugated Tilt-up Front Brackets (Portrait AC)', unit: 'pieces', image: getComponentImage('KDS-COR120-15TILT-P-F-AC') },
  'KDS-COR120-PCSLOT': { name: 'Corrugated 120mm Brackets', unit: 'pieces', image: getComponentImage('KDS-COR120-PCSLOT') },
  'KDS-CL120-15TILT-LS-R-AC': { name: 'Cliplock Tilt-up Rear Brackets (Landscape AC)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-LS-R-AC') },
  'KDS-CL120-15TILT-LS-F-AC': { name: 'Cliplock Tilt-up Front Brackets (Landscape AC)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-LS-F-AC') },
  'KDS-CL120-15TILT-LS-R-AL': { name: 'Cliplock Tilt-up Rear Brackets (Landscape AL)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-LS-R-AL') },
  'KDS-CL120-15TILT-LS-F-AL': { name: 'Cliplock Tilt-up Front Brackets (Landscape AL)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-LS-F-AL') },
  'KDS-CL120-15TILT-P-R-AC': { name: 'Cliplock Tilt-up Rear Brackets (Portrait AC)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-P-R-AC') },
  'KDS-CL120-15TILT-P-F-AC': { name: 'Cliplock Tilt-up Front Brackets (Portrait AC)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-P-F-AC') },
  'KDS-CL120-15TILT-P-R-AL': { name: 'Cliplock Tilt-up Rear Brackets (Portrait AL)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-P-R-AL') },
  'KDS-CL120-15TILT-P-F-AL': { name: 'Cliplock Tilt-up Front Brackets (Portrait AL)', unit: 'pieces', image: getComponentImage('KDS-CL120-15TILT-P-F-AL') },
  'KDS-CL120-PCSLOT': { name: 'Cliplock 120mm Brackets', unit: 'pieces', image: getComponentImage('KDS-CL120-PCSLOT') }
};
