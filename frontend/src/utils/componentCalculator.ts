...
const COMPONENT_INFO: Record<string, { name: string; unit: string; image: string }> = {
  'KDS-MC35-40P': { name: 'Mid Clamps', unit: 'pieces', image: '/images/components/KDS-MC35-40P.png' },
  'KDS-END CLAMP-P': { name: 'End Clamps (Portrait)', unit: 'pieces', image: '/images/components/KDS-END CLAMP-P.png' },
  'KDS-END CLAMP-A': { name: 'End Clamps (Angle)', unit: 'pieces', image: '/images/components/KDS-END CLAMP-A.png' },
  'KDS-EARTH-BAR-MP': { name: 'Earth Bar (Module)', unit: 'pieces', image: '/images/components/KDS-EARTH-BAR-MP.png' },
  'CLASS3-STITCH-14X22': { name: 'Self-Tapping Screws', unit: 'pieces', image: '/images/components/CLASS3-STITCH-14X22.png' },
  'KDS-IBR78-PCSLOT': { name: 'IBR Roof Brackets', unit: 'pieces', image: '/images/components/KDS-IBR78-PCSLOT.png' },
  'KDS-IBR250-ADJ2F-PCSLOT': { name: 'IBR Adjustable Brackets', unit: 'pieces', image: '/images/components/KDS-IBR250-ADJ2F-PCSLOT.png' },
  'KDS-RAIL-LT': { name: 'KDS Rails (Light)', unit: 'pieces', image: '/images/components/KDS-RAIL-LT.png' },
  'KDS-RAIL-LT-4400mm': { name: 'KDS Rails (Light) 4400mm', unit: 'pieces', image: '/images/components/KDS-RAIL-LT.png' },
  'KDS-RAIL-LT-4720mm': { name: 'KDS Rails (Light) 4720mm', unit: 'pieces', image: '/images/components/KDS-RAIL-LT.png' },
  'KDS-RAIL-LT-6600mm': { name: 'KDS Rails (Light) 6600mm', unit: 'pieces', image: '/images/components/KDS-RAIL-LT.png' },
  'KDS-U-JOIN': { name: 'Rail Joiners (U-Joint)', unit: 'pieces', image: '/images/components/KDS-U-JOIN.png' },
  'KDS-PC30': { name: 'Shared Rails (PC30)', unit: 'pieces', image: '/images/components/KDS-PC30.png' },
  'KDS-COR78-PCSLOT': { name: 'Corrugated Roof Brackets', unit: 'pieces', image: '/images/components/KDS-COR78-PCSLOT.png' },
  'KDS-COR200-PCSLOT': { name: 'Corrugated Portrait Brackets', unit: 'pieces', image: '/images/components/KDS-COR200-PCSLOT.png' },
  'KDS-CL78-PCSLOT': { name: 'Cliplock Brackets', unit: 'pieces', image: '/images/components/KDS-CL78-PCSLOT.png' },
  'KDS-CL78-PCSLOT-500NRP': { name: 'Cliplock Portrait Brackets', unit: 'pieces', image: '/images/components/KDS-CL78-PCSLOT-500NRP.png' },
  'KDS-DD120-PCSLOT': { name: 'Diamond Deck Brackets', unit: 'pieces', image: '/images/components/KDS-DD120-PCSLOT.png' },
  'KDS-NOVOT78-PCSLOT': { name: 'Novotexi Brackets (Non-penetrating)', unit: 'pieces', image: '/images/components/KDS-NOVOT78-PCSLOT.png' },
  'KDS-NOVOT78-PCSLOT-PEN': { name: 'Novotexi Brackets (Penetrating)', unit: 'pieces', image: '/images/components/KDS-NOVOT78-PCSLOT-PEN.png' },
  'KDS-HANG-BOLT-BRACKET-P': { name: 'Hang Bolt Brackets', unit: 'pieces', image: '/images/components/KDS-HANG-BOLT-BRACKET-P.png' },
  'KDS-HANG-BOLT-M10X200W': { name: 'Hang Bolts M10x200', unit: 'pieces', image: '/images/components/KDS-HANG-BOLT-M10X200W.png' },
  'KDS-DS700-78-PCSLOT': { name: 'DS700 Brackets', unit: 'pieces', image: '/images/components/KDS-DS700-78-PCSLOT.png' },
  'KDS-SLATE/HARVEY-1-KIT': { name: 'Slate/Harvey Kit', unit: 'kits', image: '/images/components/KDS-SLATE-HARVEY-1-KIT.png' },
  'KDS-SS120-4.52H-PCSLOT': { name: 'Standing Seam Brackets', unit: 'pieces', image: '/images/components/KDS-SS120-4.52H-PCSLOT.png' },
  'KDS-IBR120-15TILT-LS-F-AC': { name: 'Tilt-up Front Brackets (AC)', unit: 'pieces', image: '/images/components/KDS-IBR120-15TILT-LS-F-AC.png' },
  'KDS-IBR120-15TILT-LS-R-AC': { name: 'Tilt-up Rear Brackets (AC)', unit: 'pieces', image: '/images/components/KDS-IBR120-15TILT-LS-R-AC.png' },
  'KDS-BALLAST-HOLD': { name: 'Ballast Holders', unit: 'pieces', image: '/images/components/KDS-BALLAST-HOLD.png' },
  'KDS-BALLAST-12': { name: 'Ballast Blocks', unit: 'pieces', image: '/images/components/KDS-BALLAST-12.png' },
  'KDS-RWD-BH-LS': { name: 'A-Frame Rear Brackets', unit: 'pieces', image: '/images/components/KDS-RWD-BH-LS.png' },
  'EPDM1.5-PSA-1190X50': { name: 'EPDM Protection Mat', unit: 'meters', image: '/images/components/EPDM1.5-PSA-1190X50.png' },
  'CLASS3-TEK-SCREW-No.12x25mm-NS': { name: 'Tek Screws for Metal Roof', unit: 'pieces', image: '/images/components/CLASS3-TEK-SCREW-No.12x25mm-NS.png' },
  'KDS-AF13-25ADJ-LS-2PP-1135': { name: 'A-Frame Front Brackets (15° Adjustable)', unit: 'pieces', image: '/images/components/KDS-AF13-25ADJ-LS-2PP-1135.png' },
  'KDS-GUSSET-P-F-BH': { name: 'A-Frame Gussets', unit: 'pieces', image: '/images/components/KDS-GUSSET-P-F-BH.png' },
  'KDS-AF15FX-GUSS-LS-BNW': { name: 'A-Frame Gussets (Fixed)', unit: 'pieces', image: '/images/components/KDS-AF15FX-GUSS-LS-BNW.png' },
  'SS304-WASHER-FLAT-M12': { name: 'M12 Flat Washers (Stainless)', unit: 'pieces', image: '/images/components/SS304-WASHER-FLAT-M12.png' },
  'SS304-NUT-M12': { name: 'M12 Nuts (Stainless)', unit: 'pieces', image: '/images/components/SS304-NUT-M12.png' },
  'SS304-THREAD-M12': { name: 'M12 Threaded Rods (Stainless)', unit: 'pieces', image: '/images/components/SS304-THREAD-M12.png' },
  'KDS-SAFE-FIX300': { name: 'Ground Mounting Posts', unit: 'pieces', image: '/images/components/KDS-SAFE-FIX300.png' },
  'KDS-AF15FX-HW-PORT-BNW': { name: 'A-Frame Hardware (Portrait)', unit: 'sets', image: '/images/components/KDS-AF15FX-HW-PORT-BNW.png' },
  'KDS-AF15FX-HW-LS-BNW': { name: 'A-Frame Hardware (Landscape)', unit: 'sets', image: '/images/components/KDS-AF15FX-HW-LS-BNW.png' },
  'KDS-TILE-P': { name: 'Tile Roof Brackets', unit: 'pieces', image: '/images/components/KDS-TILE-P.png' },
  'ZP-SCREW-TPS-6.35X60': { name: 'Tile Fixing Screws 6.35x60', unit: 'pieces', image: '/images/components/ZP-SCREW-TPS-6.35X60.png' },
  'KDS-BNWT-DBL': { name: 'Double Ballast Nuts/Washers', unit: 'pieces', image: '/images/components/KDS-BNWT-DBL.png' },
  'KDS-IBR120-PCSLOT': { name: 'IBR 120mm Brackets', unit: 'pieces', image: '/images/components/KDS-IBR120-PCSLOT.png' },
  'KDS-IBR250-2F-15TILT-LS-R-AL': { name: 'IBR Tilt-up Rear Brackets (Landscape AL)', unit: 'pieces', image: '/images/components/KDS-IBR250-2F-15TILT-LS-R-AL.png' },
  'KDS-IBR250-2F-15TILT-LS-F-AL': { name: 'IBR Tilt-up Front Brackets (Landscape AL)', unit: 'pieces', image: '/images/components/KDS-IBR250-2F-15TILT-LS-F-AL.png' },
  'KDS-IBR120-15TILT-P-R-AC': { name: 'IBR Tilt-up Rear Brackets (Portrait AC)', unit: 'pieces', image: '/images/components/KDS-IBR120-15TILT-P-R-AC.png' },
  'KDS-IBR120-15TILT-P-F-AC': { name: 'IBR Tilt-up Front Brackets (Portrait AC)', unit: 'pieces', image: '/images/components/KDS-IBR120-15TILT-P-F-AC.png' },
  'KDS-IBR250-2F-15TILT-P-R-AL': { name: 'IBR Tilt-up Rear Brackets (Portrait AL)', unit: 'pieces', image: '/images/components/KDS-IBR250-2F-15TILT-P-R-AL.png' },
  'KDS-IBR250-2F-15TILT-P-F-AL': { name: 'IBR Tilt-up Front Brackets (Portrait AL)', unit: 'pieces', image: '/images/components/KDS-IBR250-2F-15TILT-P-F-AL.png' },
  'KDS-COR200-15TILT-P-R-AL': { name: 'Corrugated Tilt-up Rear Brackets (Portrait AL)', unit: 'pieces', image: '/images/components/KDS-COR200-15TILT-P-R-AL.png' },
  'KDS-COR200-15TILT-P-F-AL': { name: 'Corrugated Tilt-up Front Brackets (Portrait AL)', unit: 'pieces', image: '/images/components/KDS-COR200-15TILT-P-F-AL.png' },
  'KDS-NOVOT120-PCSLOT': { name: 'Novotexi 120mm Brackets', unit: 'pieces', image: '/images/components/KDS-NOVOT120-PCSLOT.png' },
  'KDS-DS700-120-PCSLOT': { name: 'DS700 120mm Brackets', unit: 'pieces', image: '/images/components/KDS-DS700-120-PCSLOT.png' },
  'EPDM1.5-PSA-1730x50': { name: 'EPDM Protection Mat (1730mm)', unit: 'meters', image: '/images/components/EPDM1.5-PSA-1730x50.png' },
  'KDS-RWD-BH-PORT': { name: 'A-Frame Rear Brackets (Portrait)', unit: 'pieces', image: '/images/components/KDS-RWD-BH-PORT.png' },
  'KDS-AF13-25ADJ-PORT-BNW': { name: 'A-Frame Front Brackets (Portrait Adjustable)', unit: 'pieces', image: '/images/components/KDS-AF13-25ADJ-PORT-BNW.png' },
  'KDS-AF15FX-GUSS-PORT-BNW': { name: 'A-Frame Gussets (Portrait)', unit: 'pieces', image: '/images/components/KDS-AF15FX-GUSS-PORT-BNW.png' },
  'KDS-COR120-15TILT-LS-R-AC': { name: 'Corrugated Tilt-up Rear Brackets (Landscape AC)', unit: 'pieces', image: '/images/components/KDS-COR120-15TILT-LS-R-AC.png' },
  'KDS-COR120-15TILT-LS-F-AC': { name: 'Corrugated Tilt-up Front Brackets (Landscape AC)', unit: 'pieces', image: '/images/components/KDS-COR120-15TILT-LS-F-AC.png' },
  'KDS-COR200-15TILT-LS-R-AL': { name: 'Corrugated Tilt-up Rear Brackets (Landscape AL)', unit: 'pieces', image: '/images/components/KDS-COR200-15TILT-LS-R-AL.png' },
  'KDS-COR200-15TILT-LS-F-AL': { name: 'Corrugated Tilt-up Front Brackets (Landscape AL)', unit: 'pieces', image: '/images/components/KDS-COR200-15TILT-LS-F-AL.png' },
  'KDS-COR120-15TILT-P-R-AC': { name: 'Corrugated Tilt-up Rear Brackets (Portrait AC)', unit: 'pieces', image: '/images/components/KDS-COR120-15TILT-P-R-AC.png' },
  'KDS-COR120-15TILT-P-F-AC': { name: 'Corrugated Tilt-up Front Brackets (Portrait AC)', unit: 'pieces', image: '/images/components/KDS-COR120-15TILT-P-F-AC.png' },
  'KDS-COR120-PCSLOT': { name: 'Corrugated 120mm Brackets', unit: 'pieces', image: '/images/components/KDS-COR120-PCSLOT.png' },
  'KDS-CL120-15TILT-LS-R-AC': { name: 'Cliplock Tilt-up Rear Brackets (Landscape AC)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-LS-R-AC.png' },
  'KDS-CL120-15TILT-LS-F-AC': { name: 'Cliplock Tilt-up Front Brackets (Landscape AC)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-LS-F-AC.png' },
  'KDS-CL120-15TILT-LS-R-AL': { name: 'Cliplock Tilt-up Rear Brackets (Landscape AL)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-LS-R-AL.png' },
  'KDS-CL120-15TILT-LS-F-AL': { name: 'Cliplock Tilt-up Front Brackets (Landscape AL)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-LS-F-AL.png' },
  'KDS-CL120-15TILT-P-R-AC': { name: 'Cliplock Tilt-up Rear Brackets (Portrait AC)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-P-R-AC.png' },
  'KDS-CL120-15TILT-P-F-AC': { name: 'Cliplock Tilt-up Front Brackets (Portrait AC)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-P-F-AC.png' },
  'KDS-CL120-15TILT-P-R-AL': { name: 'Cliplock Tilt-up Rear Brackets (Portrait AL)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-P-R-AL.png' },
  'KDS-CL120-15TILT-P-F-AL': { name: 'Cliplock Tilt-up Front Brackets (Portrait AL)', unit: 'pieces', image: '/images/components/KDS-CL120-15TILT-P-F-AL.png' },
  'KDS-CL120-PCSLOT': { name: 'Cliplock 120mm Brackets', unit: 'pieces', image: '/images/components/KDS-CL120-PCSLOT.png' }
};
...
function calculateGroundMountComponents(
  ...
  components.push({
    ...
    image: '/images/components/placeholder.svg',
